...
public final class Defaults {
  ...
  public static final AppConfig[] APPS = new AppConfig[]{
      new AppConfig("Go App1", "GOA1", "go-app1", "go-app1", "go-app1", "./main.go", "UAT-Deployer", "Prod-Deployer"),
      new AppConfig("Go App2", "GOA2", "go-app2", "go-app2", "go-app2", "./cmd/app/main.go", "UAT-Deployer", "Prod-Deployer"),
      new AppConfig("Go App3", "GOA3", "go-app3", "go-app3", "go-app3", "./main.go", "UAT-Deployer", "Prod-Deployer")
  };
}
